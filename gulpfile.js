...
gulp.task("themes", function() {
  return gulp
    .src(bases.app + "scss/themes/*.scss")
    .pipe(plumber({ errorHandler: onError }))
    .pipe(sourcemaps.init())
    .pipe(sass(sassOptions))
    .pipe(size({ gzip: true, showFiles: true }))
...
gulp.task("js-libs", function() {
  gulp
    .src([bases.app + "js/libs/*.js", "!" + bases.app + "js/libs/modernizr.js"])
    .pipe(uglify())
    .pipe(size({ gzip: true, showFiles: true }))
    .pipe(concat("libs.js"))
    .pipe(gulp.dest(bases.dist + "js"))
...
gulp.task("copy", function() {
  ...
  gulp
    .src(bases.app + "js/libs/modernizr.js")
    .pipe(size({ gzip: true, showFiles: true }))
  ...
  gulp
    .src([bases.app + "*.xml", bases.app + "*.txt"])
    .pipe(size({ gzip: true, showFiles: true }))
    .pipe(gulp.dest(bases.dist))
    .pipe(reload({ stream: true }));
});
...
gulp.task("sass-lint", function() {
  gulp
    .src([
      ...
      "!" + bases.app + "scss/states/_print.scss"
    ])
    .pipe(sassLint())
...
gulp.task("watch", function() {
  ...
  gulp.watch(bases.app + "js/*", ["js-app", "js-libs"]);
});
